...
namespace google { namespace protobuf { namespace compiler { namespace objectivec {
    ...
    void MessageGenerator::GenerateParseFromMethodsSource(io::Printer* printer) {
        printer->Print(
                       ...
                       "  @try { builder = [builder mergeFromData:data]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [$classname$ builder];\n"
                       "  @try { builder = [builder mergeFromData:data extensionRegistry:extensionRegistry]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromInputStream:(NSInputStream*) input {\n"
                       "  $classname$Builder* builder = [$classname$ builder];\n"
                       "  @try { builder = [builder mergeFromInputStream:input]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [$classname$ builder];\n"
                       "  @try { builder = [builder mergeFromInputStream:input extensionRegistry:extensionRegistry]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromCodedInputStream:(PBCodedInputStream*) input {\n"
                       "  $classname$Builder* builder = [$classname$ builder];\n"
                       "  @try { builder = [builder mergeFromCodedInputStream:input]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [$classname$ builder];\n"
                       "  @try { builder = [builder mergeFromCodedInputStream:input extensionRegistry:extensionRegistry]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n",
