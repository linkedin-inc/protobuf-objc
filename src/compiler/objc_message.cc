...
namespace google { namespace protobuf { namespace compiler { namespace objectivec {
    ...
    void MessageGenerator::GenerateParseFromMethodsSource(io::Printer* printer) {
        printer->Print(
                       "+ ($classname$*) parseFromData:(NSData*) data {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromData:data];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromData:(NSData*) data extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromData:data extensionRegistry:extensionRegistry];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromInputStream:(NSInputStream*) input {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromInputStream:input];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromInputStream:(NSInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromInputStream:input extensionRegistry:extensionRegistry];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromCodedInputStream:(PBCodedInputStream*) input {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromCodedInputStream:input];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n"
                       "+ ($classname$*) parseFromCodedInputStream:(PBCodedInputStream*) input extensionRegistry:(PBExtensionRegistry*) extensionRegistry {\n"
                       "  $classname$Builder* builder = [[$classname$ builder] mergeFromCodedInputStream:input extensionRegistry:extensionRegistry];\n"
                       "  $classname$* message;\n"
                       "  @try { message = [builder build]; } @catch (NSException *exception) { builder = nil; @throw exception; }\n"
                       "  return message;\n"
                       "}\n",
